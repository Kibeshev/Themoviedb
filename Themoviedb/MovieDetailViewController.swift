...
class MovieDetailViewController: UIViewController, UIScrollViewDelegate{
    ...
    private func loadData() {
        guard let moviesID = movies.id else {
           return
        }
    ...
    private func fillBudget(budget: Int?) {
        ...
        let formattedNumber = formatter.string(from: NSNumber(value: budget))
    ...
    private func fillRevenue(revenue: Int?){
        ...
        let formattedNumber = formatter.string(from: NSNumber(value: revenue))
